...
- `org.eclipse.fennec.services.telemetry` — OpenTelemetry hinter den beiden Nähten (#126): `CallTracer` (W3C-Kontext über REST-Header bzw. CloudEvents-Extensions) und die Runtime-Services als Gauges. Bringt eigene W3C-Propagatoren mit, weil die OSGi-Technology-Integration einen Noop registriert; die otel-Bundles kommen als Snapshot von Central
