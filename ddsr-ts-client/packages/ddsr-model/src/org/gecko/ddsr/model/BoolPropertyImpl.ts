...
/**
 * Implementation of BoolProperty
 * @generated
 */
export class BoolPropertyImpl extends PropertyImpl implements BoolProperty {
  ...
  override eClass(): EClass {
    return DDSRPackage.Literals.BOOL_PROPERTY;
  }
  ...
  set value(value: boolean) {
    ...
    if (this.eDeliver()) {
      this.eNotify({
        getNotifier: () => this,
        getEventType: () => 1, // SET
        getFeature: () => this.eClass().getEStructuralFeature(BoolPropertyImpl.VALUE),
        ...
        isTouch: () => false,
        isReset: () => false,
        getFeatureID: () => BoolPropertyImpl.VALUE,
        merge: () => false
      });
    }
  }
