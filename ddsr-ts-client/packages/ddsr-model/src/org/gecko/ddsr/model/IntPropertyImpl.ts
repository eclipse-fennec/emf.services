...
/**
 * Implementation of IntProperty
 * @generated
 */
export class IntPropertyImpl extends PropertyImpl implements IntProperty {
  ...
  override eClass(): EClass {
    return DDSRPackage.Literals.INT_PROPERTY;
  }
  ...
  set value(value: number) {
    ...
    if (this.eDeliver()) {
      this.eNotify({
        getNotifier: () => this,
        getEventType: () => 1, // SET
        getFeature: () => this.eClass().getEStructuralFeature(IntPropertyImpl.VALUE),
        ...
        isTouch: () => false,
        isReset: () => false,
        getFeatureID: () => IntPropertyImpl.VALUE,
        merge: () => false
      });
    }
  }
