 ...
 * @generated
 */
export class LongPropertyImpl extends PropertyImpl implements LongProperty {
  ...
  override eClass(): EClass {
    return DDSRPackage.Literals.LONG_PROPERTY;
  }
  ...
  set value(value: number) {
    ...
    if (this.eDeliver()) {
      this.eNotify({
        getNotifier: () => this,
        getEventType: () => 1, // SET
        getFeature: () => this.eClass().getEStructuralFeature(LongPropertyImpl.VALUE),
        ...
        isTouch: () => false,
        isReset: () => false,
        getFeatureID: () => LongPropertyImpl.VALUE,
        merge: () => false
      });
    }
  }
