...
/**
 * Implementation of PythonBinding
 * @generated
 */
export class PythonBindingImpl extends LanguageBindingImpl implements PythonBinding {
  ...
  override eClass(): EClass {
    return DDSRPackage.Literals.PYTHON_BINDING;
  }
