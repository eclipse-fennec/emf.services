...
/**
 * Implementation of ShortProperty
 * @generated
 */
export class ShortPropertyImpl extends PropertyImpl implements ShortProperty {
  ...
  override eClass(): EClass {
    return DDSRPackage.Literals.SHORT_PROPERTY;
  }
  ...
  set value(value: number) {
    ...
    if (this.eDeliver()) {
      this.eNotify({
        getNotifier: () => this,
        getEventType: () => 1, // SET
        getFeature: () => this.eClass().getEStructuralFeature(ShortPropertyImpl.VALUE),
        ...
        isTouch: () => false,
        isReset: () => false,
        getFeatureID: () => ShortPropertyImpl.VALUE,
        merge: () => false
      });
    }
  }
