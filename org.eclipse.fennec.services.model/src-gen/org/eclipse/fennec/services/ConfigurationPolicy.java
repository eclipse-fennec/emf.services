 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Whether a component depends on Configuration Admin. OPTIONAL = activate without configuration if none is present; REQUIRE = activate only when configuration is present; IGNORE = never consult configuration.
 * <!-- end-model-doc -->
 * @see org.eclipse.fennec.services.ServicesPackage#getConfigurationPolicy()
 * @model
 * @generated
 */
@ProviderType
