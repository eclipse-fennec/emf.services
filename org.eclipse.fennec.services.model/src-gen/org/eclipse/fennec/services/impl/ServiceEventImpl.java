 ...
 * @generated
 */
public class ServiceEventImpl extends MinimalEObjectImpl.Container implements ServiceEvent {
	/**
	 ...
	 * @ordered
	 */
	protected static final ServiceEventType TYPE_EDEFAULT = ServiceEventType.UNSPECIFIED;
	 ...
	 * @ordered
	 */
	protected ServiceEventType type = TYPE_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return ServicesPackage.Literals.SERVICE_EVENT;
	}
	 ...
	 */
	@Override
	public void setType(ServiceEventType newType) {
		ServiceEventType oldType = type;
		type = newType == null ? TYPE_EDEFAULT : newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicesPackage.SERVICE_EVENT__TYPE, oldType, type));
	}
	...
	public ServiceReference getReference() {
		if (reference != null && reference.eIsProxy()) {
			...
			if (reference != oldReference) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ServicesPackage.SERVICE_EVENT__REFERENCE, oldReference, reference));
			}
		}
		return reference;
	}
	...
	public void setReference(ServiceReference newReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicesPackage.SERVICE_EVENT__REFERENCE, oldReference, reference));
	}
	...
	public void setTimestamp(Date newTimestamp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicesPackage.SERVICE_EVENT__TIMESTAMP, oldTimestamp, timestamp));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ServicesPackage.SERVICE_EVENT__TYPE:
				return getType();
			case ServicesPackage.SERVICE_EVENT__REFERENCE:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ServicesPackage.SERVICE_EVENT__TYPE:
				setType((ServiceEventType)newValue);
				return;
			case ServicesPackage.SERVICE_EVENT__REFERENCE:
